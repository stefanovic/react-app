...
const Contact = () => {
  ...
  const [transitionSpeed, setTransitionSpeed] = useState(500); // Default transition speed
...
// In useEffect
const termSpring = useSpring({
  from: { opacity: 0, backgroundColor: termSets[selectedSet][currentTermIndex].color },
  to: { opacity: 1, backgroundColor: termSets[selectedSet][currentTermIndex].color },
  config: { duration: transitionSpeed }, // Use selected transition speed
  reset: true,
});
      ...
      <div className="row mb-4">
        <div className="col-md-6 mb-2">
          ...
          <div className="card shadow-sm">
            <animated.div className="card-body" style={termSpring}>
              <h2 className="card-title mb-3">Term</h2>
              <animated.p ref={boxRef} onClick={handleBoxClick}>
...
<br></br>
Transition Speed <select value={transitionSpeed} onChange={(e) => handleSpeedChange(Number(e.target.value))}>
